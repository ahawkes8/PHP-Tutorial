...
$f_name = "Andrew"; // String
$l_name = 'Hawkes'; // You can use single quotes
$age = 21; // Integer
$height = 1.77; // Float
    ...
    # Check if anything was passed to the web page and if the state key exists
      if(isset($_GET) && array_key_exists('state', $_GET)){
        ...
        if(count($_GET) >= 3){
          ...
          $me_info = array('Name'=>'Andrew', 'Street'=>'123 Main');
          ...
          $customers = array(array('Andrew', '123 Main'),
          ...
          printf("Key : %s<br>", array_search('Andrew', $me_info));
          # Is value in array
